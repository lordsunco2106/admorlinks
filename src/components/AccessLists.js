  ...
  render() {
      ...
      <React.Fragment>
        <div className="py-5">
          ...
          <p className="text-red text-uppercase mt-0"><strong>NOTE: discount</strong> on every phones and products purchased,<strong> buy now pay later available terms and condition apply</strong>
          </p>
            ...
            <form>
            <input type="text" placeholder="Search here..." className="searchstyle" onChange={this.searchHand}>
              ...
              {
                this.state.accessories.filter(searchingFor(this.state.cools)).map( but => 
                    <div key={accessories.rep}>
                    <div className="row my-3 ">
                    <div className="col-md-4">
                   <p><img src={but.photo} className="img-fluid" alt="product"></img></p>
                      </div>
                   ...
                   <p>{but.btty}</p>
                    ...
                    <p>PRICE : <span>&#8358;</span>{but.amount}</p>
                    <Link to="/default">
