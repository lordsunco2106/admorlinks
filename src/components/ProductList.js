        ...
        <div className="py-3">
          <div className="container">
            <p className="text-yellow text-uppercase">
              <strong>
                Admor Links Phone Store Sell Phones, Accessories, Laptop, we
                also provide services like Phone Swap, Software Update, Repairs,
                Our Engineer are Fast and Reliable, Amazing Offers such as BUY
                NOW PAY LATER(BNPL), EASYBUY, Discount on any Phone Purchases,
                Free Gifts and December Packages, Phones & Gadget Your
            ...
            <div className="row">
              <ProductConsumer>
                {(value) => {
                      ...
                      <ul type="none" className="my-3">
                        <li key={company}>
                          <a
                            ...
                            onClick={() => value.filterItem(company)}
                          >
                            {company}
                          </a>
                        </li>
                  ...
                  const products = (
                    value.filteredProducts || value.products
                  ).map((product) => {
